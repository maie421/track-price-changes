...
(
    id          int auto_increment
        primary key,
    market_product_id  varchar(255)                              not null comment '상품 id',
    market_category_id varchar(255)                              not null comment '카테고리 id',
...
(
    ...
    product_id       varchar(255)                        not null comment 'url 노출 상품 id',
